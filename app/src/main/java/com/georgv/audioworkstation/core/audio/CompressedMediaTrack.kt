...
internal object CompressedMediaTrack {
    ...
    private const val DurationRoundingOffsetUs = 999L
    private const val MicrosPerMillisecond = 1_000L
    ...
    fun readDurationMs(trackFormat: MediaFormat): Long {
        ...
        return (durationUs + DurationRoundingOffsetUs) / MicrosPerMillisecond
    }
